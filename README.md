...
* **Previsioni giornaliere**: contiene le vendite previste per ciascuna combinazione modello/colore/taglia per ogni giorno delle due settimane successive.
* **Riepilogo due settimane**: aggrega le previsioni giornaliere mostrando il totale previsto nel periodo, utile per pianificare riassortimenti.
